...
def cube_turning(maps: list):
    ...
    rotation = {(1, 2): (4, 0), (1, 3): (6, 0),
                (2, 0): (5, 2), (2, 1): (3, 2), (2, 3): (6, 3),
                (3, 0): (2, 3), (3, 2): (4, 1),
                (4, 2): (1, 0), (4, 3): (3, 0),
                (5, 0): (2, 2), (5, 1): (6, 2),
                (6, 0): (5, 3), (6, 1): (2, 1), (6, 2): (1, 1)}
...
direction = [direc if (direc == 'R' or direc == 'L') else int(direc) for direc in direction]

part1 = navigation(board, direction, 1)
print((part1[0][0]+1)*1000+(part1[0][1]+1)*4+part1[1])

part2 = navigation(board, direction, 2)
print((part2[0][0]+1)*1000+(part2[0][1]+1)*4+part2[1])
